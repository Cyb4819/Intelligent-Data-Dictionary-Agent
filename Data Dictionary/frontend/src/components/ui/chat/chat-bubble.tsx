...
const chatBubbleMessageVariants = cva("p-3 px-6", {
    ...
    variant: {
      received:
        "glass-card border border-white/10 text-secondary-foreground rounded-2xl py-2",
      sent: "glass-card border border-white/10 text-secondary-foreground rounded-3xl",
    },
    layout: {
      default: "",
